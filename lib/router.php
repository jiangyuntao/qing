...
class Router {
    ...
    public function __construct() {
        $this->_dealRoutes($this->_getRoutes());
    }
     ...
     */
    public function map($routeUrl = '', $target = '', $args = array()) {
        $route = new Route();
    ...
    private function _dealRoutes($routes = array()) {
        foreach ($routes as $key => $value) {
            ...
            $this->map($key, $handler, array('name' => $name));
        }
        return true;
    }
}
